...
import { useFcoseWorkerLayout } from "../hooks/useFcoseWorkerLayout";
...
type GraphViewProps = {
  ...
  layoutOptions?: FcoseLayoutOptions;
...
export const GraphView = ({
  ...
  selectedAddress,
  onSelectAddress,
  layoutOptions = DEFAULT_FCOSE_OPTIONS,
  isProcessing = false,
}: GraphViewProps) => {
  ...
  const { positions, isLayouting } = useFcoseWorkerLayout({
    elements,
