...
import { FocusControls } from "@/features/cytoscape/cose/components/FocusControls";
import { NetworkSummary } from "@/features/cytoscape/cose/components/NetworkSummary";
import { AddressInsightsPanel } from "@/features/cytoscape/cose/components/AddressInsightsPanel";
import { DataSourceControls } from "@/features/cytoscape/cose/components/DataSourceControls";

import { useAddressInsights } from "@/features/cytoscape/cose/hooks/useAddressInsights";
import { useAddressFocus } from "@/features/cytoscape/cose/hooks/useAddressFocus";
import { useTransactionData } from "@/features/cytoscape/cose/hooks/useTransactionData";
import { useGraphBuilder } from "@/features/cytoscape/cose/hooks/useGraphBuilder";
import { useGraphFocus } from "@/features/cytoscape/cose/hooks/useGraphFocus";
import { useTopAddresses } from "@/features/cytoscape/cose/hooks/useTopAddresses";

import { DEFAULT_DATA_SOURCE } from "@/features/cytoscape/cose/domain/constants";
import { FCOSE_WORKER_LIMITS } from "../domain/constants";

import { GraphView } from "./GraphView";

const { MAX_ADDRESSES, BLOCK_WINDOW_MIN } = FCOSE_WORKER_LIMITS;

export function GraphLayoutPage() {
