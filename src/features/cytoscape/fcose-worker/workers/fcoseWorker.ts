...
/**
 * Worker API for fCOSE layout calculations.
 * Runs layout computation in a separate thread to prevent main thread blocking.
 */
const workerApi = {
  /**
   * Calculates fCOSE layout positions for the given graph.
   ...
   */
  calculateLayout(input: FcoseLayoutInput): FcoseLayoutOutput {
...
export type FcoseWorkerApi = typeof workerApi;
